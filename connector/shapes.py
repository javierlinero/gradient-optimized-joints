...
if __name__ == '__main__':
    ...
    # opt.init_shape_params =  [6.5, 10, 11.5, 3, 20, 8.5]
    # opt.init_shape_params = [6.305242351068401, 10.616245376843008, 10.748600434084143, 3.8306186758173095, 20.050559532624067, 8.750592608718092]
    ...
    #opt.init_shape_params = [1.6826460301619806, 1.712865650960244, 14.348849101053295, 8.217687240631284, 13.8332207335239, 5.815645634294847]
    ...
    # #         9.912842091263183
    # #     ]
    # opt.init_shape_params = [10., 5., 5., 4.75, 7.5, 5., 12.5, 10.]
